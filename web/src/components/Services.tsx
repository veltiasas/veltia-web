...
import { FileText, Brain, RefreshCcw, CloudCog, Lightbulb, Leaf } from "lucide-react";
    ...
    <section id="servicios" className="py-24 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <motion.div
            variants={fadeInUp}
            className="mt-10 glass-card p-6 flex items-center gap-4 text-center md:text-left md:flex-row flex-col"
            style={{ borderColor: "rgba(34,197,94,0.15)" }}
          >
            <Leaf size={28} className="text-green shrink-0" />
            <p className="text-sm text-ice-muted leading-relaxed">
              <span className="text-green font-medium">Cada servicio que implementamos reduce tu huella de carbono.</span>{" "}
              Menos papel. Menos energia. Menos recursos ociosos. Impacto medible.
            </p>
          </motion.div>
        </motion.div>
      </div>
