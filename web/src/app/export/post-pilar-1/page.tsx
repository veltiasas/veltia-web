...
const metrics = [
  { pct: "-70%", text: "tiempo busqueda documentos" },
  { pct: "-60%", text: "ciclo aprobaciones" },
  { pct: "-50%", text: "demoras por firma" },
];

export default function PostPilar1Page() {
  return (
    <div
      style={{
        width: "1080px",
